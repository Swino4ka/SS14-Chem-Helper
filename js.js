...
// Словарь температурных требований для реакций (в Кельвинах)
const reactionTemps = {
  "Сигинат": 370,
  "Инсузин": 433,
  "Пиразин": 540,
...
function updateDetailedList() {
  ...
  // Добавляем подсказку по использованию гайда
  ...
  guideHelp.innerHTML = `
    ...
    <ol>
      ...
      <li>Обратите внимание на требуемую температуру для реакций, отмеченных значком 🔥.</li>
    </ol>
  `;
